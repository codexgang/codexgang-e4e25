...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/601e4e256dd9f2001621e36d
...
To start editing your site, you can use the Sanity interface at https://codexgang-e4e25.sanity.studio/.
...
Generated at `2021-02-06T08:37:54.413Z` by Stackbit version `0.3.47`.